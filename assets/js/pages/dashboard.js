...
$(function() {
    ...
    sparkline("#new-visitors", "line", 30, 50, "basis", 750, 2000, "rgba(255,255,255,0.5)");
    sparkline("#new-sessions", "line", 30, 50, "basis", 750, 2000, "rgba(255,255,255,0.5)");
    // Chart setup
    ...
    dailyRevenue('#total-online', 50); // initialize chart
